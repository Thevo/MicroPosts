!(function (t) {
        ...
        (t.exports = function (t, n, r, a) {
          ...
          b
            ? ((v = r(function (t, r, e, o) {
                ...
                if (S(r)) {
                  if (
                    ...
                    return bt in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (p = Et(e, n));
                  var g = r.byteLength;
                  if (void 0 === o) {
            ...
            : (i(function () {
              ...
              K(m !== Function.prototype ? P(g).concat(P(m)) : P(g), function (
                t
              ) {
                t in v || h(v, t, g[t]);
              }),
  ...
  function (t, n, r) {
    ...
    t.exports = function (t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        F = P || S(d),
        M = d ? (_ ? S("entries") : F) : void 0,
        A = ("Array" == n && O.entries) || P;
      if (
        (A &&
          (x = s(A.call(new t()))) !== Object.prototype &&
          x.next &&
          (f(x, w, !0), e || "function" == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          "values" !== P.name &&
          ((E = !0),
  ...
  function (t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = E(t)) != t || t === w
          ...
          : ((e = P(F(t) / M)),
            t * (i = O(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + f >= 1 ? s / i : s * O(2, 1 - f)) * i >= 2 &&
              (e++, (i /= 2)),
            e + f >= a
              ? ((o = 0), (e = a))
              : e + f >= 1
              ? ((o = (t * i - 1) * O(2, n)), (e += f))
              : ((o = t * O(2, f - 1) * O(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[A]._b, a = u + t[j], f = e(+o), s = 0; s < n; s++)
        c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
  ...
  function (t, n, r) {
    ...
    r(123);
    var e,
      o = (e = r(295)) && e.__esModule ? e : { default: e };
  ...
  function (t, n, r) {
    ...
    var e = r(1),
      ...
      H = function (t, n) {
        m(t);
        for (var r, e = y((n = S(n))), o = 0, i = e.length; i > o; )
          K(t, (r = e[o++]), n[r]);
        return t;
      },
      X = function (t) {
        ...
        return (
          !(this === G && o(U, t) && !o(B, t)) &&
          (!(n || !o(this, t) || !o(U, t) || (o(this, k) && this[k][t])) || n)
        );
      },
      Z = function (t, n) {
        if (((t = S(t)), (n = w(n, !0)), t !== G || !o(U, n) || o(B, n))) {
          var r = I(t, n);
          return (
            !r || !o(U, n) || (o(t, k) && t[k][n]) || (r.enumerable = !0), r
          );
        }
      },
      Q = function (t) {
        for (var n, r = N(S(t)), e = [], i = 0; r.length > i; )
          o(U, (n = r[i++])) || n == k || n == a || e.push(n);
        return e;
      },
      tt = function (t) {
        for (
          var n, r = t === G, e = N(r ? B : S(t)), i = [], u = 0;
          e.length > u;
    ...
    V ||
      (c(
        (T = function () {
          ...
          return i && z && Y(G, t, { configurable: !0, set: n }), J(t);
        }).prototype,
        "toString",
        function () {
          return this._k;
      ...
      (r(45).f = X),
      (F.f = tt),
      i && !r(30) && c(G, "propertyIsEnumerable", X, !0),
      (v.f = function (t) {
        return J(p(t));
      })),
    ...
    for (
      ...
      p(nt[rt++]);
    for (var et = A(p.store), ot = 0; et.length > ot; ) d(et[ot++]);
    u(u.S + u.F * !V, "Symbol", {
      for: function (t) {
        ...
        function (t, n) {
          ...
          for (var x, S = "", w = 0, _ = 0; _ < m.length; _++) {
            ...
            for (
              ...
              P.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [E].concat(P, O, h);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = d(E, h, O, P, M, n);
  ...
  function (t, n, r) {
    var e = (function (t) {
          ...
          (i._invoke = (function (t, n, r) {
            ...
            return function (o, i) {
              ...
              for (r.method = o, r.arg = i; ; ) {
                ...
                if ("normal" === s.type) {
                  if (
                    ((e = r.done ? "completed" : "suspendedYield"), s.arg === f)
                  )
                    continue;
                  return { value: s.arg, done: r.done };
                }
                "throw" === s.type &&
                  ((e = "completed"), (r.method = "throw"), (r.arg = s.arg));
              }
            };
          })(t, r, u)),
          i
      ...
      function b(t, n) {
        ...
        if ("throw" === e.type)
          return (n.method = "throw"), (n.arg = e.arg), (n.delegate = null), f;
        var o = e.arg;
        return o
          ? o.done
  ...
  function (t, n, r) {
              ...
              return regeneratorRuntime.async(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (e.next = 2), regeneratorRuntime.awrap(fetch(t));
                    case 2:
                      return (
                        (n = e.sent),
                        (e.next = 5),
                        regeneratorRuntime.awrap(n.json())
                      );
                    case 5:
                  ...
                  switch ((o.prev = o.next)) {
                    ...
                    case 2:
                      return (
                        (r = o.sent),
                        (o.next = 5),
                        regeneratorRuntime.awrap(r.json())
                      );
                    case 5:
                      return (e = o.sent), o.abrupt("return", e);
                    case 7:
                    case "end":
                      return o.stop();
                  }
                  ...
                  switch ((r.prev = r.next)) {
                    ...
                    case 2:
                      return (
                        r.sent,
                        (r.next = 5),
                        regeneratorRuntime.awrap("Resource Deleted...")
                      );
                    case 5:
        ...
        (r = [
          ...
          },
          {
            ...
            value: function (t, n) {
              ...
              (e.className = n), e.appendChild(document.createTextNode(t));
              var o = document.querySelector(".postsContainer"),
                i = document.querySelector("#posts");
              o.insertBefore(e, i),
                setTimeout(function () {
                  r.clearAlert();
                }, 3e3);
          ...
          },
          {
            ...
            value: function (t) {
              if ("edit" === t) {
                ...
                (n.className = "post-cancel btn btn-light btn-block"),
                  n.appendChild(document.createTextNode("Cancel edit"));
                var r = document.querySelector(".card-form"),
                  e = document.querySelector(".form-end");
                r.insertBefore(n, e);
              } else
    ...
    function c() {
      o.get("http://localhost:3000/posts")
        .then(function (t) {
          return u.showPosts(t);
        })
        .catch(function (t) {
    ...
    document.addEventListener("DOMContentLoaded", c),
      document
        ...
        .addEventListener("click", function () {
          var t = document.querySelector("#title").value,
            n = document.querySelector("#body").value,
            r = document.querySelector("#id").value,
            e = { title: t, body: n };
          "" === t || "" === n
            ? u.showAlert("Please fill all fields", "alert alert-danger")
            : "" === r
            ? o
                .post("http://localhost:3000/posts", e)
                .then(function (t) {
                  u.showAlert("Post added", "alert alert-success"),
                    u.clearFields(),
                    c();
                })
                .catch(function (t) {
            ...
            : o
                .put("http://localhost:3000/posts/".concat(r), e)
                .then(function (t) {
                  u.showAlert("Post updated", "alert alert-success"),
                    u.changeFormState("add"),
                    c();
                })
                .catch(function (t) {
                  return console.log(t);
      ...
      document.querySelector("#posts").addEventListener("click", function (t) {
        if (
          (t.preventDefault(),
          t.target.parentElement.classList.contains("delete"))
        ) {
          var n = t.target.parentElement.dataset.id;
          confirm("Are you sure?") &&
            o
              .delete("http://localhost:3000/posts/".concat(n))
              .then(function (t) {
                u.showAlert("Post deleted", "alert alert-success"), c();
              })
              .catch(function (t) {
                return console.log(t);
              });
      ...
      document.querySelector("#posts").addEventListener("click", function (t) {
        if (t.target.parentElement.classList.contains("edit")) {
          var n = t.target.parentElement.dataset.id,
            r =
              t.target.parentElement.previousElementSibling
                .previousElementSibling.textContent,
            e = t.target.parentElement.previousElementSibling.textContent,
            o = { id: n, title: r, body: e };
          u.fillForm(o);
        }
        t.preventDefault();
      }),
      document
        ...
        .addEventListener("click", function (t) {
          t.target.classList.contains("post-cancel") &&
            u.changeFormState("add");
          t.preventDefault();
        });
  },
